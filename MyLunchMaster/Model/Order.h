...
- (id) initWithId:(NSNumber *)id date:(NSString *) date dayOfWeekString:(NSString *) dayOfWeekString dayOfWeekNumber:(NSNumber *)dayOfWeekNumber price:(NSString *) price meal:(Meal *) meal;
